      ...
      <DialogContent className="max-w-2xl bg-white/90 backdrop-blur-md">
        ...
        <ScrollArea className="h-[400px] pr-4">
          <div className="space-y-4 text-sm text-muted-foreground">
            <p className="font-semibold text-foreground">Last updated on 05-02-2025 00:08:21</p>
            
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding 
              agreement by and between JEEVA, ("Website Owner" or "we" or "us" or "our") and you ("you" or 
